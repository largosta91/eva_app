...
export const GIFTS = [
  ...
  { id: 2, name: "Fuego",    emoji: "🔥", cost: 12,   color: "#ff4500", soundKey: "basico"  },
  { id: 3, name: "Corazón",  emoji: "❤️", cost: 10,   color: "#ff0000", soundKey: "basico"  },
  { id: 4, name: "Rosa",     emoji: "🌹", cost: 7,    color: "#ff007f", soundKey: "rosa"    },
  { id: 5, name: "Copa",     emoji: "🍷", cost: 20,   color: "#9b2335", soundKey: "copa"    },
