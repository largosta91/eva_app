...
export const GIFTS = [
  // --- ECONÓMICOS / ROMPEHIELOS (5 a 25 créditos) ---
  ...
  // --- ALTOS / DISTINCIÓN (500 a 1500 créditos) ---
  { id: 11, name: "ORO",           emoji: "💰", image: "/lluviadeoro.gif",    cost: 500,  color: "#c9a84c", soundKey: "tragamoneda",   duration: 4300 },
  { id: 12, name: "Corona",        emoji: "👑", image: "/corona.webp",        cost: 600,  color: "#ffd700", soundKey: "asombro",       duration: 4000 },
  { id: 13, name: "Auto",          emoji: "🏎️", image: "/car1.gif",           cost: 1900, color: "#ef4444", soundKey: "japonTokio",   duration: 5000},

  // --- PREMIUM / ULTRA VIP / VEHÍCULOS (1900 a 5000 créditos) ---
  ...
  { id: 17, name: "Unicornio",     emoji: "🦄", image: "/unicornio.gif",      cost: 4000, color: "#c084fc", soundKey: "unicornio",      duration: 4000 },
