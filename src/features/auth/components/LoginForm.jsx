...
export default function LoginForm() {
  ...
  {/* Contenedor con efecto brillo UNA sola vez */}
  ...
  <p className="text-[#c9a84c] text-sm mt-2">Iniciá sesión para continuar</p>
      ...
      <button
        onClick={handleLogin}
        className="w-full py-4 rounded-full font-semibold text-[15px] text-[#09080f] bg-gradient-to-r from-[#8b3a9c] to-[#c9a84c] border-none cursor-pointer shadow-[0_8px_30px_rgba(139,58,156,.3)] text-white"
      >
        Entrar
      </button>
