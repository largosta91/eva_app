  ...
  return (
    <div className="px-6 pt-5 pb-32 flex flex-col overflow-y-auto animate-fadeIn">
        ...
        <div className="mt-4 text-center">
          <div className="flex items-center justify-center gap-2">
            ...
            <button
              ...
              className="text-[#7a748f] hover:text-[#c9a84c]"
            >
              ✏️
            </button>
          ...
          <p className="text-[#7a748f] text-[11px] uppercase tracking-[3px] mt-1 font-bold">
            Mi Perfil
          </p>
        </div>
      </div>
      ...
      <div className="bg-[#1a1826] rounded-3xl p-6 mb-3 flex items-center justify-between">
        <div>
          <p className="text-[#7a748f] text-xs uppercase font-bold">
            Diamantes
          </p>
          <p className="text-3xl font-bold text-[#c9a84c] mt-1">
            💎 {credits}
          </p>
        </div>
      ...
      <button
        onClick={onLogout}
        className="mt-4 w-full py-4 text-[#5a5470] hover:text-red-400"
      >
